...
+ **Clima** - Les variables meteorològiques es van obtenir a 500m de Meteoland App**, interpolades a partir de les dades d'estacions meteorològiques oferides per [AEMET](https://www.aemet.es/es/portada), el [Servei Meteorlogic de Catalunya](https://www.meteo.cat/), [MeteoGalicia](https://www.meteogalicia.gal/web/home) i la [Red de Información Agroclimática de Andalucia](https://www.juntadeandalucia.es/agriculturaypesca/ifapa/riaweb/web/inicio_estaciones).
